        ...
        init: function (options) {
            ...
            return this.each(function () {
                ...
                if( settings.dragField ) {
                    ...
                    $( settings.dragField )[0].addEventListener("drop",function(e){
    ...
    var uploader = {
        ...
        initButtonText: function () {
            ...
            var button =    '<span class="uploadfive-button '+settings.buttonClass+'" style="cursor:'+settings.buttonCursor+';" id="'+settings.id+'">'+
                                ...
                                '<input title="点击选择文件" type="file"'+accept+' id="'+instanceID+'" name="'+instanceID+'" '+(settings.multi ? 'multiple="multiple"' : '')+' />'+
                            '</span>';
